    ...
    this.$get = function ($rootScope, $timeout) {
      ...
      var wrappedSocket = {
        ...
        get: function(url, data, callback) {
          if (callback) {
            socket.get(url, data, asyncAngularify(callback));
          } else {
            socket.get(url, data);
          }
        },
        ...
        post: function(url, data, callback) {
          if (callback) {
            socket.post(url, data, asyncAngularify(callback));
          } else {
        ...
        put: function(url, data, callback) {
          if (callback) {
            socket.put(url, data, asyncAngularify(callback));
          } else {
            socket.put(url, data);
          }
        },
        // expose socket.delete
        'delete': function(url, data, callback) {
          if (callback) {
            socket.delete(url, data, asyncAngularify(callback));
          } else {
