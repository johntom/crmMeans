...
module.exports = function (grunt) {
   ...
   * dependencies, e.g. `npm install grunt-contrib-sass`
   // link(rel="stylesheet", href="/linker/styles/angular-table.css")
   'js/lib/bootstrap/css/bootstrap.css',
   'js/lib/bootstrap/css/bootstrap-combined.min.css',
   */
...
//    'js/lib/angular/angular-1.0.8/angular-cookies.js',
    ...
    'js/lib/angular/ng-grid-csv-export.js',
    'js/lib/angular/ui-multicombo.js',
    'js/lib/transition.js',
    'js/lib/jsapi.js',
    'js/lib/debounce.js',
     // make goople chart responsive
  ...
  grunt.registerTask('logger', 'logger description', function (msg, special) {
    grunt.log.writeln(
      'Warning:::Logger: '
        + msg
